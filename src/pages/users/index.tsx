...
export function Users() {
  ...
  const { data, loading } = useQuery<{ usersByName: User[] }>(
    GET_USER_BY_NAME,
    {
        ...
        <>
          ...
          <div className="border rounded">
            <Table>
              <TableHeader>
                <TableHead></TableHead>
                <TableHead className="xs:hidden">Username</TableHead>
                <TableHead>Nome</TableHead>
                <TableHead className="xs:hidden">E-mail</TableHead>
                <TableHead className="xs:hidden">Função</TableHead>
                <TableHead></TableHead>
              </TableHeader>
              <TableBody>
                {usersOnCurrentPage.map((data) => (
                  <TableRow key={data.id}>
                    ...
                    <TableCell className="xs:hidden">{data.email}</TableCell>
                    <TableCell className="xs:hidden">
                      {data.accessLevel}
                    </TableCell>
                    <TableCell>
